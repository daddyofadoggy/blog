...
<div class="gradio-embed-container">
  ...
  <div id="fallback-container" style="display: none; text-align: center; margin: 20px 0;">
    ...
    <img 
      src="https://huggingface.co/spaces/doggdad/InstructGPTFinetuned/resolve/main/thumbnail.png" 
  ...
  <div class="gradio-notes">
    ...
    <div class="example-prompts">
      ...
      <button class="example-button" onclick="copyToInput('Write a short poem about artificial intelligence')">Write a poem about AI</button>
      <button class="example-button" onclick="copyToInput('Explain the concept of neural networks in simple terms')">Explain neural networks</button>
      <button class="example-button" onclick="copyToInput('What are the main differences between supervised and unsupervised learning?')">Supervised vs. unsupervised</button>
    </div>
  </div>
</div>
